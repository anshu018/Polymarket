...
```bash
INIT=$(node C:/Users/ash74/.gemini/get-shit-done/bin/gsd-tools.cjs state load)
...
```bash
node C:/Users/ash74/.gemini/get-shit-done/bin/gsd-tools.cjs commit "docs: resolve debug {slug}" --files .planning/debug/resolved/{slug}.md
```
